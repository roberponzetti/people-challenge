  ...
  return (
    <form className="mb-10 sticky top-0" >   
      ...
      <div className="relative">
        ...
        <input type="search" id="default-search" className="block w-full p-4 ps-10 text-md text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-dark-yellow-star-wars focus:border-dark-yellow-star-wars" placeholder="Nombre, apellido..." required />
